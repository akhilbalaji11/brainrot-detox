var Ae=Object.defineProperty;var Le=(x,y,T)=>y in x?Ae(x,y,{enumerable:!0,configurable:!0,writable:!0,value:T}):x[y]=T;var h=(x,y,T)=>Le(x,typeof y!="symbol"?y+"":y,T);(function(){"use strict";const x={basedMax:35,mediumMax:65,intervention:80,cooldownMs:6e4},y={active:!1,mode:"items",limit:10,consumed:0,startedAt:0},T={active:!1,endsAt:0,bypassCount:0},Z=["[>] Step outside for 2 minutes","[~] Drink a glass of water","[o] Do 5 deep breaths","[!] Do 10 jumping jacks","[*] Look at something 20 feet away for 20 seconds","[♪] Put on your favorite song","[>] Text a friend something nice","[=] Open a window and feel the air"],P={based:{emoji:"( ._.)",label:"Based",hint:"Keep it chill, you're doing great."},medium:{emoji:"(-_-;)",label:"Medium Cooked",hint:"Maybe take a breather soon?"},cooked:{emoji:"(x_x) ",label:"Absolutely Cooked",hint:"Bro. Step away from the screen."}},Q=[{id:"Chill",emoji:"~_~",label:"Just Vibing"},{id:"Learn",emoji:"o_O",label:"Learn Something"},{id:"Laugh",emoji:"xD",label:"Get Entertained"},{id:"Music",emoji:"♪♫",label:"Music / Audio"},{id:"JustHere",emoji:"...",label:"I'm Just Here"}],B=.3,ee=15e3,te=500,se=3e3,oe=2e3,N=4e3,ie=.35,re=3,F={edge:"right",verticalOffset:20};function A(t){return Math.max(0,Math.min(100,t))}function ae(t){return t==="Chill"||t==="Laugh"?15e3:t==="Learn"||t==="JustHere"?25e3:2e4}function ne(t,s,e,o){const i=Math.min(1,t/s),r=Math.min(1,e/150),a=Math.min(1,o/60),n=i*35+r*35+a*30;return Math.round(Math.min(100,n))}function de(t,s,e,o,i){const r=i==="Learn"?1.3:i==="JustHere"?1.1:i==="Laugh"?.8:i==="Chill"?.7:1;if(e){const n=s*r,c=t*(1-B)+n*B;return A(c)}if(o<ee)return t;const a=o<45e3?1:o<9e4?2:4;return A(t-a)}function ce(t,s,e,o){if(s>0)return A(t+s);const i=ae(e);return o<i?t:o<6e4?A(t-1):A(t-3)}function le(t,s=x){return t<=s.basedMax?"Based":t<=s.mediumMax?"Medium Cooked":"Absolutely Cooked"}function W(t){return t==="Based"?P.based:t==="Medium Cooked"?P.medium:P.cooked}function he(t,s,e=x,o=Date.now()){return!(t<e.intervention||o-s<e.cooldownMs)}function ue(t){return t>=100}const U="brd_widget_positions";async function be(t,s){return(await chrome.storage.local.get(t))[t]??s}async function pe(t,s){await chrome.storage.local.set({[t]:s})}async function $(){return be(U,{})}async function me(t){return(await $())[t]??F}async function fe(t,s){const e=await $();e[t]=s,await pe(U,e)}const G="brd-overlay-host",ge=8;let m=null,w={...F},f=null,I=null;function Y(){if(m)return m;let t=document.getElementById(G);if(t||(t=document.createElement("div"),t.id=G,t.style.cssText="position:fixed;top:0;left:0;width:0;height:0;z-index:2147483647;pointer-events:none;",document.documentElement.appendChild(t)),t.shadowRoot)return m=t.shadowRoot,K(),m;m=t.attachShadow({mode:"open"});const s=document.createElement("style");s.textContent=Se,m.appendChild(s);const e=document.createElement("link");return e.rel="stylesheet",e.href="https://fonts.googleapis.com/css2?family=Caveat:wght@400;600;700&family=Patrick+Hand&display=swap",m.appendChild(e),K(),m}function L(t,s){const e=Y(),o=e.querySelector(`[data-overlay="${t}"]`);o&&o.remove();const i=document.createElement("div");return i.setAttribute("data-overlay",t),i.innerHTML=s,e.appendChild(i),i}function ve(t){const s=Y();I=t.onActivate??null;let e=s.querySelector('[data-overlay="widget"]');if(!e){e=document.createElement("div"),e.setAttribute("data-overlay","widget"),e.innerHTML=`
    ...
    `,s.appendChild(e);const o=e.querySelector(".brd-widget");o&&(f==null||f(),f=ke(o,t.siteKey))}return we(e,t),_(),e}function u(t){const s=m;if(!s)return;const e=s.querySelector(`[data-overlay="${t}"]`);e&&(t==="widget"&&(f==null||f(),f=null,I=null),e.remove())}function ye(){const t=m;t&&(f==null||f(),f=null,I=null,t.querySelectorAll("[data-overlay]").forEach(s=>s.remove()))}async function xe(t){w=await me(t),_()}async function K(){var o;const t=await chrome.runtime.sendMessage({type:"GET_SETTINGS"}),s=t!=null&&t.success&&((o=t.data)!=null&&o.theme)?t.data.theme:"light",e=document.getElementById(G);e&&(s==="dark"?e.classList.add("brd-dark"):e.classList.remove("brd-dark"))}function we(t,s){const e=t.querySelector(".brd-widget");if(!e)return;e.dataset.score=s.score.toFixed(3),e.dataset.status=s.status;const o=W(s.status),i=s.status==="Based"?"brd-score-based":s.status==="Medium Cooked"?"brd-score-medium":"brd-score-cooked",r=e.querySelector(".brd-widget-emoji"),a=e.querySelector(".brd-widget-label"),n=e.querySelector(".brd-widget-score"),c=e.querySelector(".brd-widget-pack"),g=e.querySelector(".brd-widget-pack-label"),p=e.querySelector(".brd-pack-fill");r&&(r.textContent=o.emoji),a&&(a.textContent=o.label),n&&(n.textContent=String(Math.round(s.score)),n.className=`brd-widget-score ${i}`),c&&g&&p&&(s.pack?(c.hidden=!1,g.textContent=s.pack.label,p.style.width=`${Math.max(0,Math.min(100,s.pack.percent))}%`):(c.hidden=!0,g.textContent="",p.style.width="0%"))}function _(){const t=m==null?void 0:m.querySelector(".brd-widget");t&&(t.style.left=w.edge==="left"?"0px":"auto",t.style.right=w.edge==="right"?"0px":"auto",t.style.bottom=`${z(w.verticalOffset,t)}px`)}function ke(t,s){let e=null,o=!1,i=0,r=0,a=0;const n=()=>{e=null,o=!1,t.style.cursor="grab",t.style.transition="all 0.2s ease"},c=d=>{d.pointerType==="mouse"&&d.button!==0||d.target.closest("button, input, a")||(e=d.pointerId,o=!1,i=d.clientX,r=d.clientY,a=window.innerHeight-t.getBoundingClientRect().bottom,t.style.cursor="grabbing",t.style.transition="none",t.setPointerCapture(d.pointerId),d.preventDefault())},g=d=>{if(e!==d.pointerId)return;const E=d.clientX-i,S=r-d.clientY;if(!o&&Math.hypot(E,S)>=ge&&(o=!0),!o)return;const l=z(a+S,t);t.style.left=w.edge==="left"?"0px":"auto",t.style.right=w.edge==="right"?"0px":"auto",t.style.bottom=`${l}px`},p=async d=>{if(e!==d.pointerId)return;const E=o;if(t.hasPointerCapture(d.pointerId)&&t.releasePointerCapture(d.pointerId),E){const S=t.getBoundingClientRect();w={edge:d.clientX<window.innerWidth/2?"left":"right",verticalOffset:z(window.innerHeight-S.bottom,t)},_(),await fe(s,w)}else I==null||I();n()},k=d=>{e===d.pointerId&&(t.hasPointerCapture(d.pointerId)&&t.releasePointerCapture(d.pointerId),_(),n())};return t.addEventListener("pointerdown",c),t.addEventListener("pointermove",g),t.addEventListener("pointerup",p),t.addEventListener("pointercancel",k),t.style.cursor="grab",()=>{t.removeEventListener("pointerdown",c),t.removeEventListener("pointermove",g),t.removeEventListener("pointerup",p),t.removeEventListener("pointercancel",k)}}function z(t,s){const e=Math.max(0,window.innerHeight-s.getBoundingClientRect().height-8);return Math.max(0,Math.min(t,e))}const Se=`
...
`;function b(t){return new Promise(s=>{chrome.runtime.sendMessage(t,e=>{chrome.runtime.lastError?s({success:!1,error:chrome.runtime.lastError.message}):s(e??{success:!1,error:"No response"})})})}function Ce(t,s=1){return t.active?{...t,consumed:t.consumed+s}:t}function Te(t,s=Date.now()){return t.active?t.mode==="items"?t.consumed>=t.limit:t.mode==="time"?(s-t.startedAt)/6e4>=t.limit:!1:!1}function Ee(t,s=Date.now()){if(!t.active)return{current:0,total:0,percent:0};if(t.mode==="items")return{current:t.consumed,total:t.limit,percent:Math.min(100,Math.round(t.consumed/t.limit*100))};const e=(s-t.startedAt)/6e4,o=Math.max(0,t.limit-e),i=Math.floor(o),r=Math.floor((o-i)*60);return{current:Math.round(e),total:t.limit,percent:Math.min(100,Math.round(e/t.limit*100)),timeRemaining:`${String(i).padStart(2,"0")}:${String(r).padStart(2,"0")}`}}const R="brd:locationchange";class Ie{constructor(){h(this,"settings");h(this,"session");h(this,"enabled",!1);h(this,"lastSignalAt",0);h(this,"lastActivityAt",0);h(this,"scrollCount",0);h(this,"swipeCount",0);h(this,"maxCookedShown",!1);h(this,"builtDifferentDismissed",!1);h(this,"tickTimer",null);h(this,"cleanupFns",[]);h(this,"velocitySamples",[])}async init(){var s;this.enabled&&this.destroy();try{const e=await b({type:"GET_SETTINGS"});if(!e.success)return;if(this.settings=e.data,!this.settings.masterEnabled||!((s=this.settings.sites[this.site])!=null&&s.enabled)){console.log(`[brainrot detox] Disabled for ${this.site}`);return}const o=await this.getCurrentTabId(),i=await b({type:"GET_SESSION",payload:{tabId:o}});i.data?this.session=i.data:(this.session={site:this.site,tabId:o,startedAt:Date.now(),cookedScore:0,cookedStatus:"Based",lastInterventionAt:0,packState:{...y},touchGrass:{...T},vibeIntent:this.settings.vibeCheck.activeIntent,itemsConsumed:0,scrollEvents:0},await b({type:"UPDATE_SESSION",payload:{tabId:o,patch:this.session}})),this.enabled=!0,this.lastSignalAt=0,this.lastActivityAt=Date.now(),this.velocitySamples=[],await xe(this.site),this.mountCookedWidget(),this.setupObservers(),this.scheduleNextTick(),this.session.touchGrass.active&&this.session.touchGrass.endsAt>Date.now()&&this.showTouchGrassOverlay(),console.log(`[brainrot detox] ${this.site} adapter initialized`)}catch(e){console.error(`[brainrot detox] Init error for ${this.site}:`,e)}}destroy(){for(this.enabled=!1,this.tickTimer!==null&&(clearTimeout(this.tickTimer),this.tickTimer=null);this.cleanupFns.length>0;){const s=this.cleanupFns.pop();try{s==null||s()}catch(e){console.warn(`[brainrot detox] Cleanup error for ${this.site}:`,e)}}this.velocitySamples=[],this.removeAllOverlays()}scheduleNextTick(){if(!this.enabled)return;this.tickTimer!==null&&clearTimeout(this.tickTimer);const s=Date.now()-this.lastActivityAt<oe?te:se;this.tickTimer=window.setTimeout(async()=>{await this.tick(),this.scheduleNextTick()},s)}recordActivity(s=Date.now()){this.lastActivityAt=s}recordSignalUnits(s,e=Date.now()){s<=0||(this.velocitySamples.push({at:e,units:s}),this.lastSignalAt=e,this.recordActivity(e),this.pruneVelocitySamples(e))}recordSuccessfulNavigation(s=1,e=Date.now()){s<=0||(this.swipeCount+=s,this.recordSignalUnits(s,e))}getVelocityMultiplier(s=Date.now()){this.pruneVelocitySamples(s);const o=this.velocitySamples.reduce((i,r)=>i+r.units,0)/(N/1e3);return Math.min(re,1+ie*Math.pow(o,1.5))}addCleanup(s){this.cleanupFns.push(s)}registerEventListener(s,e,o,i){s.addEventListener(e,o,i),this.addCleanup(()=>s.removeEventListener(e,o,i))}registerMutationObserver(s,e,o){const i=new MutationObserver(o);return i.observe(s,e),this.addCleanup(()=>i.disconnect()),i}registerInterval(s,e){const o=window.setInterval(s,e);return this.addCleanup(()=>clearInterval(o)),o}registerRuntimeMessageListener(s){chrome.runtime.onMessage.addListener(s),this.addCleanup(()=>chrome.runtime.onMessage.removeListener(s))}registerLocationChangeListener(s){const e=window;let o=e.__brdLocationChangePatch;if(!o){const i=()=>window.dispatchEvent(new Event(R)),r=history.pushState,a=history.replaceState;history.pushState=function(...n){const c=r.apply(history,n);return i(),c},history.replaceState=function(...n){const c=a.apply(history,n);return i(),c},window.addEventListener("popstate",i),o={refCount:0,popstateListener:i,originalPushState:r,originalReplaceState:a},e.__brdLocationChangePatch=o}o.refCount++,window.addEventListener(R,s),this.addCleanup(()=>{window.removeEventListener(R,s);const i=e.__brdLocationChangePatch;i&&(i.refCount--,!(i.refCount>0)&&(history.pushState=i.originalPushState,history.replaceState=i.originalReplaceState,window.removeEventListener("popstate",i.popstateListener),delete e.__brdLocationChangePatch))})}buildPackDisplay(){if(!this.session.packState.active)return null;const s=Ee(this.session.packState);return{label:this.session.packState.mode==="time"&&s.timeRemaining?`[#] Pack: ${s.timeRemaining}`:`[#] Pack: ${s.current}/${s.total}`,percent:s.percent}}renderCookedWidget(s,e){ve({siteKey:this.site,score:s,status:e,pack:this.buildPackDisplay(),onActivate:()=>this.showVibeCheckOverlay()})}getGeneralVelocityUnits(s){return s+this.scrollCount*.25}computeGeneralBurstBonus(s,e){return s<=0?0:Math.max(0,e-1)*Math.min(12,s)*.6}resetMomentum(){this.velocitySamples=[],this.lastSignalAt=0}async tick(){if(!this.enabled)return;const s=Date.now(),e=this.session.cookedScore,o=this.getNewItemsSinceLastTick();this.session.itemsConsumed+=o,this.session.scrollEvents+=this.scrollCount;const i=this.scrollCount>0||o>0||this.swipeCount>0,r=this.lastSignalAt===0?0:s-this.lastSignalAt;if(this.builtDifferentDismissed&&i){this.builtDifferentDismissed=!1,this.scrollCount=0,this.swipeCount=0,this.onBuiltDifferentDenied();return}let a=e;if(this.session.packState.active)a=e;else if(this.site==="shorts"){const n=o*this.getVelocityMultiplier(s);a=ce(e,n,this.session.vibeIntent,r)}else{const n=this.getGeneralVelocityUnits(o);n>0&&this.recordSignalUnits(n,s);const c=(s-this.session.startedAt)/6e4,g=ne(c,this.settings.cooked.sessionCapMinutes,this.session.scrollEvents,this.session.itemsConsumed),p=this.getVelocityMultiplier(s),k=de(e,g,i,r,this.session.vibeIntent);a=Math.min(100,k+this.computeGeneralBurstBonus(n,p))}this.scrollCount=0,this.swipeCount=0,this.session.cookedScore=a,this.session.cookedStatus=le(a,this.settings.cooked.thresholds),this.session.packState.active&&(this.session.packState=Ce(this.session.packState,o),Te(this.session.packState,s)&&this.onPackComplete()),this.session.packState.active||(ue(a)?this.maxCookedShown||(this.maxCookedShown=!0,this.onMaxCooked()):(a<95&&(this.maxCookedShown=!1),a>=e&&he(a,this.session.lastInterventionAt,this.settings.cooked.thresholds,s)&&(this.session.lastInterventionAt=s,this.onIntervention()))),this.updateCookedWidget(this.session.cookedScore,this.session.cookedStatus),await b({type:"UPDATE_SESSION",payload:{tabId:this.session.tabId,patch:this.session}})}onIntervention(){b({type:"LOG_EVENT",payload:{eventType:"intervention"}}),this.showInterventionOverlay()}onMaxCooked(){this.session.lastInterventionAt=Date.now(),b({type:"LOG_EVENT",payload:{eventType:"intervention"}}),this.showSkyrimOverlay("Your brain is absolutely cooked (x_x)")}onPackComplete(){this.session.packState={...y},this.maxCookedShown=!1,b({type:"END_PACK",payload:{tabId:this.session.tabId}}),this.showSkyrimOverlay("[#] Pack Complete! Time to touch grass."),this.updateCookedWidget(this.session.cookedScore,this.session.cookedStatus)}onBuiltDifferentDenied(){this.showBuiltDifferentDeniedOverlay()}async startPack(s,e){await b({type:"START_PACK",payload:{tabId:this.session.tabId,mode:s,limit:e}}),this.session.packState={active:!0,mode:s,limit:e,consumed:0,startedAt:Date.now()},this.session.cookedScore=0,this.session.cookedStatus="Based",this.maxCookedShown=!1,this.builtDifferentDismissed=!1,this.resetMomentum(),this.updateCookedWidget(this.session.cookedScore,this.session.cookedStatus)}async startTouchGrass(s){await b({type:"START_TOUCH_GRASS",payload:{tabId:this.session.tabId,minutes:s}}),this.session.touchGrass={active:!0,endsAt:Date.now()+s*6e4,bypassCount:0},this.showTouchGrassOverlay()}async endTouchGrass(){await b({type:"END_TOUCH_GRASS",payload:{tabId:this.session.tabId}}),this.session.touchGrass={...T},this.session.cookedScore=0,this.session.cookedStatus="Based",this.maxCookedShown=!1,this.resetMomentum(),this.removeAllOverlays(),this.mountCookedWidget()}async bypassTouchGrass(){this.session.touchGrass.bypassCount++,b({type:"LOG_EVENT",payload:{eventType:"bypass"}}),await this.endTouchGrass()}setVibeIntent(s){this.session.vibeIntent=s,b({type:"UPDATE_SESSION",payload:{tabId:this.session.tabId,patch:{vibeIntent:s}}}),b({type:"LOG_EVENT",payload:{eventType:"vibe_check"}})}pruneVelocitySamples(s=Date.now()){this.velocitySamples=this.velocitySamples.filter(e=>s-e.at<=N)}async getCurrentTabId(){return new Promise(s=>{const e=Math.floor(Math.random()*1e6);b({type:"GET_CURRENT_TAB"}).then(o=>{var i;s(((i=o.data)==null?void 0:i.id)??e)})})}}class Me extends Ie{constructor(){super(...arguments);h(this,"site","shorts");h(this,"itemsSinceLastTick",0);h(this,"lastVideoId","");h(this,"handleRuntimeMessage",(e,o,i)=>{var r,a,n;return e.type==="END_TOUCH_GRASS"?(this.session.touchGrass={active:!1,endsAt:0,bypassCount:0},u("skyrim"),u("touchgrass"),this.thawFeed(),i({success:!0}),!1):e.type==="TRIGGER_TOUCH_GRASS"?(this.startTouchGrass(((r=e.payload)==null?void 0:r.minutes)??5),i({success:!0}),!1):e.type==="TRIGGER_PACK"?(this.startPack(((a=e.payload)==null?void 0:a.mode)??"items",((n=e.payload)==null?void 0:n.limit)??10),i({success:!0}),!1):(e.type==="TRIGGER_VIBE_CHECK"&&(this.showVibeCheckOverlay(),i({success:!0})),!1)})}getShortsVideo(){return document.querySelector("ytd-shorts video")??document.querySelector(".html5-main-video")??document.querySelector("video.video-stream")??null}freezeFeed(){const e=this.getShortsVideo();e&&!e.paused&&e.pause()}thawFeed(){const e=this.getShortsVideo();e&&e.paused&&e.play().catch(()=>{})}setupObservers(){this.registerEventListener(window,"scroll",()=>{this.scrollCount++,this.recordActivity()},{passive:!0}),this.registerEventListener(window,"wheel",r=>{Math.abs(r.deltaY)>20&&(this.scrollCount++,this.recordActivity())},{passive:!0}),this.registerEventListener(window,"keydown",r=>{const a=r;(a.key==="ArrowDown"||a.key==="j")&&(this.scrollCount++,this.recordActivity())},{passive:!0});let e=0;this.registerEventListener(window,"touchstart",r=>{var a;e=((a=r.touches[0])==null?void 0:a.clientY)??0},{passive:!0}),this.registerEventListener(window,"touchend",r=>{var n;const a=e-(((n=r.changedTouches[0])==null?void 0:n.clientY)??0);Math.abs(a)>50&&(this.scrollCount++,this.recordActivity())},{passive:!0});const o=()=>{const r=window.location.pathname.match(/\/shorts\/([^/?]+)/),a=(r==null?void 0:r[1])??"";if(a){if(!this.lastVideoId){this.lastVideoId=a;return}a!==this.lastVideoId&&(this.lastVideoId=a,this.itemsSinceLastTick++,this.recordSuccessfulNavigation())}};this.registerLocationChangeListener(o),this.registerInterval(o,250),o();const i=()=>{const r=document.body??document.documentElement;this.registerMutationObserver(r,{childList:!0,subtree:!0},()=>o())};document.readyState==="complete"?i():this.registerEventListener(window,"load",i,{once:!0}),this.registerRuntimeMessageListener(this.handleRuntimeMessage)}getNewItemsSinceLastTick(){const e=this.itemsSinceLastTick;return this.itemsSinceLastTick=0,e}mountCookedWidget(){this.renderCookedWidget(this.session.cookedScore,this.session.cookedStatus)}updateCookedWidget(e,o){this.renderCookedWidget(e,o)}showInterventionOverlay(){var i,r,a;const e=W(this.session.cookedStatus),o=L("intervention",`
    ...
    `);(i=o.querySelector("[data-action='dismiss']"))==null||i.addEventListener("click",()=>u("intervention")),(r=o.querySelector("[data-action='pack']"))==null||r.addEventListener("click",()=>{u("intervention"),this.startPack("items",10)}),(a=o.querySelector("[data-action='grass']"))==null||a.addEventListener("click",()=>{u("intervention"),this.startTouchGrass(this.settings.touchGrass.defaultMinutes)})}showBuiltDifferentDeniedOverlay(){var o,i,r;this.freezeFeed();const e=L("denied",`
      <div class="brd-fullscreen">
        <div class="brd-card">
    ...
    `);o.querySelectorAll("[data-vibe]").forEach(r=>{r.addEventListener("click",()=>{this.setVibeIntent(r.dataset.vibe),u("vibecheck")})}),(i=o.querySelector("[data-action='skip']"))==null||i.addEventListener("click",()=>u("vibecheck"))}removeAllOverlays(){ye(),this.thawFeed()}stopZenAudio(e,o){if(!(!e||!o))try{o.gain.linearRampToValueAtTime(0,e.currentTime+.5),window.setTimeout(()=>{e.close()},600)}catch{}}stopWebcam(e){e&&e.getTracks().forEach(o=>o.stop())}}console.log("[brainrot detox] Shorts content script loaded"),new Me().init()})();
