var N=Object.defineProperty;var U=(m,u,f)=>u in m?N(m,u,{enumerable:!0,configurable:!0,writable:!0,value:f}):m[u]=f;var b=(m,u,f)=>U(m,typeof u!="symbol"?u+"":u,f);(function(){"use strict";const m={basedMax:35,mediumMax:65,intervention:80,cooldownMs:6e4},u={active:!1,mode:"items",limit:10,consumed:0,startedAt:0},f={active:!1,endsAt:0,bypassCount:0},S=["[>] Step outside for 2 minutes","[~] Drink a glass of water","[o] Do 5 deep breaths","[!] Do 10 jumping jacks","[*] Look at something 20 feet away for 20 seconds","[♪] Put on your favorite song","[>] Text a friend something nice","[=] Open a window and feel the air"],y={based:{emoji:"( ._.)",label:"Based",hint:"Keep it chill, you're doing great."},medium:{emoji:"(-_-;)",label:"Medium Cooked",hint:"Maybe take a breather soon?"},cooked:{emoji:"(x_x) ",label:"Absolutely Cooked",hint:"Bro. Step away from the screen."}},C=[{id:"Chill",emoji:"~_~",label:"Just Vibing"},{id:"Learn",emoji:"o_O",label:"Learn Something"},{id:"Laugh",emoji:"xD",label:"Get Entertained"},{id:"Music",emoji:"♪♫",label:"Music / Audio"},{id:"JustHere",emoji:"...",label:"I'm Just Here"}],g=.3,T=3e3,E=15e3;function I(e,i,t,o){const s=Math.min(1,e/i),a=Math.min(1,t/150),n=Math.min(1,o/60),r=s*35+a*35+n*30;return Math.round(Math.min(100,r))}function A(e,i,t,o,s){const a=s==="Learn"?1.3:s==="JustHere"?1.1:s==="Laugh"?.8:s==="Chill"?.7:1;if(t){const r=i*a,d=e*(1-g)+r*g;return Math.max(0,Math.min(100,Math.round(d)))}if(o<E)return e;const n=o<45e3?1:o<9e4?2:4;return Math.max(0,e-n)}function M(e,i,t,o){return i>0?Math.max(0,Math.min(100,e+i)):o<(t==="Chill"||t==="Laugh"?15e3:t==="Learn"||t==="JustHere"?25e3:2e4)?e:o<6e4?Math.max(0,e-1):Math.max(0,e-3)}function L(e,i=m){return e<=i.basedMax?"Based":e<=i.mediumMax?"Medium Cooked":"Absolutely Cooked"}function k(e){return e==="Based"?y.based:e==="Medium Cooked"?y.medium:y.cooked}function G(e,i,t=m,o=Date.now()){return!(e<t.intervention||o-i<t.cooldownMs)}function _(e){return e>=100}function O(e,i=1){return e.active?{...e,consumed:e.consumed+i}:e}function D(e,i=Date.now()){return e.active?e.mode==="items"?e.consumed>=e.limit:e.mode==="time"?(i-e.startedAt)/6e4>=e.limit:!1:!1}function P(e,i=Date.now()){if(!e.active)return{current:0,total:0,percent:0};if(e.mode==="items")return{current:e.consumed,total:e.limit,percent:Math.min(100,Math.round(e.consumed/e.limit*100))};const t=(i-e.startedAt)/6e4,o=Math.max(0,e.limit-t),s=Math.floor(o),a=Math.floor((o-s)*60);return{current:Math.round(t),total:e.limit,percent:Math.min(100,Math.round(t/e.limit*100)),timeRemaining:`${String(s).padStart(2,"0")}:${String(a).padStart(2,"0")}`}}const w="brd-overlay-host";let p=null;function z(){if(p)return p;let e=document.getElementById(w);if(e||(e=document.createElement("div"),e.id=w,e.style.cssText="position:fixed;top:0;left:0;width:0;height:0;z-index:2147483647;pointer-events:none;",document.documentElement.appendChild(e)),e.shadowRoot)return p=e.shadowRoot,p;p=e.attachShadow({mode:"open"});const i=document.createElement("style");i.textContent=$,p.appendChild(i);const t=document.createElement("link");return t.rel="stylesheet",t.href="https://fonts.googleapis.com/css2?family=Caveat:wght@400;600;700&family=Patrick+Hand&display=swap",p.appendChild(t),p}function v(e,i){const t=z(),o=t.querySelector(`[data-overlay="${e}"]`);o&&o.remove();const s=document.createElement("div");return s.setAttribute("data-overlay",e),s.innerHTML=i,t.appendChild(s),s}function c(e){if(!p)return;const i=p.querySelector(`[data-overlay="${e}"]`);i&&i.remove()}function R(){p&&p.querySelectorAll("[data-overlay]").forEach(e=>e.remove())}const $=`
...
`;function l(e){return new Promise(i=>{chrome.runtime.sendMessage(e,t=>{chrome.runtime.lastError?i({success:!1,error:chrome.runtime.lastError.message}):i(t??{success:!1,error:"No response"})})})}class j{constructor(){b(this,"settings");b(this,"session");b(this,"enabled",!1);b(this,"tickTimer",null);b(this,"lastSignalAt",0);b(this,"scrollCount",0);b(this,"swipeCount",0);b(this,"maxCookedShown",!1);b(this,"builtDifferentDismissed",!1)}async init(){var i;try{const t=await l({type:"GET_SETTINGS"});if(!t.success)return;if(this.settings=t.data,!this.settings.masterEnabled||!((i=this.settings.sites[this.site])!=null&&i.enabled)){console.log(`[brainrot detox] Disabled for ${this.site}`);return}const o=await this.getCurrentTabId();let s=await l({type:"GET_SESSION",payload:{tabId:o}});s.data?this.session=s.data:(this.session={site:this.site,tabId:o,startedAt:Date.now(),cookedScore:0,cookedStatus:"Based",lastInterventionAt:0,packState:{...u},touchGrass:{...f},vibeIntent:this.settings.vibeCheck.activeIntent,itemsConsumed:0,scrollEvents:0},await l({type:"UPDATE_SESSION",payload:{tabId:o,patch:this.session}})),this.enabled=!0,console.log(`[brainrot detox] ${this.site} adapter initialized`),this.mountCookedWidget(),this.setupObservers(),this.tickTimer=window.setInterval(()=>this.tick(),T),this.session.touchGrass.active&&this.session.touchGrass.endsAt>Date.now()&&this.showTouchGrassOverlay()}catch(t){console.error(`[brainrot detox] Init error for ${this.site}:`,t)}}destroy(){this.enabled=!1,this.tickTimer&&clearInterval(this.tickTimer),this.removeAllOverlays()}async tick(){if(!this.enabled)return;const i=Date.now(),t=this.getNewItemsSinceLastTick();this.session.itemsConsumed+=t,this.session.scrollEvents+=this.scrollCount;const o=this.scrollCount>0||t>0||this.swipeCount>0;o&&(this.lastSignalAt=i);const s=this.lastSignalAt===0?0:i-this.lastSignalAt;if(this.builtDifferentDismissed&&o){this.builtDifferentDismissed=!1,this.scrollCount=0,this.swipeCount=0,this.onBuiltDifferentDenied();return}let a;if(this.session.packState.active)a=this.session.cookedScore;else if(this.site==="shorts")a=M(this.session.cookedScore,this.swipeCount,this.session.vibeIntent,s);else{const r=(i-this.session.startedAt)/6e4,d=I(r,this.settings.cooked.sessionCapMinutes,this.session.scrollEvents,this.session.itemsConsumed);a=A(this.session.cookedScore,d,o,s,this.session.vibeIntent)}this.scrollCount=0,this.swipeCount=0,this.session.cookedScore=a,this.session.cookedStatus=L(a,this.settings.cooked.thresholds),this.session.packState.active&&(this.session.packState=O(this.session.packState,t),D(this.session.packState,i)&&this.onPackComplete()),this.session.packState.active||(_(a)?this.maxCookedShown||(this.maxCookedShown=!0,this.onMaxCooked()):(a<95&&(this.maxCookedShown=!1),a>=this.session.cookedScore&&G(a,this.session.lastInterventionAt,this.settings.cooked.thresholds,i)&&(this.session.lastInterventionAt=i,this.onIntervention()))),this.updateCookedWidget(this.session.cookedScore,this.session.cookedStatus);const n=this.session.tabId;await l({type:"UPDATE_SESSION",payload:{tabId:n,patch:this.session}})}async getCurrentTabId(){return new Promise(i=>{const t=Math.floor(Math.random()*1e6);l({type:"GET_CURRENT_TAB"}).then(o=>{var s;i(((s=o.data)==null?void 0:s.id)??t)})})}onIntervention(){l({type:"LOG_EVENT",payload:{eventType:"intervention"}}),this.showInterventionOverlay()}onMaxCooked(){this.session.lastInterventionAt=Date.now(),l({type:"LOG_EVENT",payload:{eventType:"intervention"}}),this.showSkyrimOverlay("Your brain is absolutely cooked (x_x)")}onPackComplete(){this.session.packState={...u},this.maxCookedShown=!1,l({type:"END_PACK",payload:{tabId:this.session.tabId}}),this.showSkyrimOverlay("[#] Pack Complete! Time to touch grass.")}onBuiltDifferentDenied(){this.showBuiltDifferentDeniedOverlay()}async startPack(i,t){await l({type:"START_PACK",payload:{tabId:this.session.tabId,mode:i,limit:t}}),this.session.packState={active:!0,mode:i,limit:t,consumed:0,startedAt:Date.now()},this.session.cookedScore=0,this.session.cookedStatus="Based",this.maxCookedShown=!1,this.builtDifferentDismissed=!1}async startTouchGrass(i){await l({type:"START_TOUCH_GRASS",payload:{tabId:this.session.tabId,minutes:i}}),this.session.touchGrass={active:!0,endsAt:Date.now()+i*6e4,bypassCount:0},this.showTouchGrassOverlay()}async endTouchGrass(){await l({type:"END_TOUCH_GRASS",payload:{tabId:this.session.tabId}}),this.session.touchGrass={...f},this.session.cookedScore=0,this.session.cookedStatus="Based",this.maxCookedShown=!1,this.removeAllOverlays()}async bypassTouchGrass(){this.session.touchGrass.bypassCount++,l({type:"LOG_EVENT",payload:{eventType:"bypass"}}),await this.endTouchGrass()}setVibeIntent(i){this.session.vibeIntent=i,l({type:"UPDATE_SESSION",payload:{tabId:this.session.tabId,patch:{vibeIntent:i}}}),l({type:"LOG_EVENT",payload:{eventType:"vibe_check"}})}}class H extends j{constructor(){super(...arguments);b(this,"site","youtube");b(this,"itemsSinceLastTick",0);b(this,"lastSeenItems",0)}setupObservers(){window.addEventListener("scroll",()=>{this.scrollCount++},{passive:!0});const t=new MutationObserver(()=>{const s=document.querySelectorAll("ytd-rich-item-renderer, ytd-video-renderer, ytd-compact-video-renderer");s.length>this.lastSeenItems&&(this.itemsSinceLastTick+=s.length-this.lastSeenItems,this.lastSeenItems=s.length)}),o=()=>{const s=document.querySelector("ytd-browse, ytd-search, ytd-watch-flexy, #content")||document.body;t.observe(s,{childList:!0,subtree:!0})};document.readyState==="complete"?o():window.addEventListener("load",o),window.addEventListener("yt-navigate-finish",()=>{this.lastSeenItems=0}),chrome.runtime.onMessage.addListener((s,a,n)=>{var r,d,h;return s.type==="END_TOUCH_GRASS"?(this.session.touchGrass={active:!1,endsAt:0,bypassCount:0},c("skyrim"),c("touchgrass"),n({success:!0}),!1):s.type==="TRIGGER_TOUCH_GRASS"?(this.startTouchGrass(((r=s.payload)==null?void 0:r.minutes)??5),n({success:!0}),!1):s.type==="TRIGGER_PACK"?(this.startPack(((d=s.payload)==null?void 0:d.mode)??"items",((h=s.payload)==null?void 0:h.limit)??10),n({success:!0}),!1):(s.type==="TRIGGER_VIBE_CHECK"&&(this.showVibeCheckOverlay(),n({success:!0})),!1)})}getNewItemsSinceLastTick(){const t=this.itemsSinceLastTick;return this.itemsSinceLastTick=0,t}mountCookedWidget(){this.updateCookedWidget(this.session.cookedScore,this.session.cookedStatus)}updateCookedWidget(t,o){const s=k(o),a=o==="Based"?"brd-score-based":o==="Medium Cooked"?"brd-score-medium":"brd-score-cooked";let n="";if(this.session.packState.active){const h=P(this.session.packState);n=`<div style="width:100%;margin-top:6px;"><div style="font-size:10px;color:#94a3b8;margin-bottom:3px;">${this.session.packState.mode==="time"&&h.timeRemaining?`[#] Pack: ${h.timeRemaining}`:`[#] Pack: ${h.current}/${h.total}`}</div><div class="brd-pack-bar"><div class="brd-pack-fill" style="width:${h.percent}%"></div></div></div>`}const d=v("widget",`<div class="brd-widget"><span class="brd-widget-emoji">${s.emoji}</span><span class="brd-widget-label">${s.label}</span><span class="brd-widget-score ${a}">${t}</span>${n}</div>`).querySelector(".brd-widget");d&&(d.style.cursor="pointer",d.onclick=()=>this.showVibeCheckOverlay())}showInterventionOverlay(){var s,a,n;const t=k(this.session.cookedStatus),o=v("intervention",`<div class="brd-fullscreen"><div class="brd-card"><h2>${t.emoji} ${t.label}!</h2><p>Your scrolling score hit ${this.session.cookedScore}. Time to make a choice:</p><div class="brd-btn-row"><button class="brd-btn brd-btn-ghost" data-action="dismiss">Keep Going 🤷</button><button class="brd-btn brd-btn-primary" data-action="pack">Start Pack 🍱</button><button class="brd-btn brd-btn-success" data-action="grass">Touch Grass 🌿</button></div></div></div>`);(s=o.querySelector("[data-action='dismiss']"))==null||s.addEventListener("click",()=>c("intervention")),(a=o.querySelector("[data-action='pack']"))==null||a.addEventListener("click",()=>{c("intervention"),this.startPack("items",10)}),(n=o.querySelector("[data-action='grass']"))==null||n.addEventListener("click",()=>{c("intervention"),this.startTouchGrass(this.settings.touchGrass.defaultMinutes)})}showSkyrimOverlay(t){var a,n,r,d;const o=chrome.runtime.getURL("assets/skyrim-skeleton.mp4"),s=v("skyrim",`<div class="brd-fullscreen"><div class="brd-video-wrap"><video autoplay muted playsinline><source src="${o}" type="video/mp4"></video></div><div class="brd-message">${t}</div><div class="brd-btn-row"><button class="brd-btn brd-btn-success" data-action="grass">🌿 Touch Grass</button><button class="brd-btn brd-btn-primary" data-action="pack">🍱 Start Pack</button><button class="brd-btn brd-btn-ghost" data-action="dismiss">I'm Built Different 💪</button></div></div>`);(a=s.querySelector("video"))==null||a.play().catch(()=>{}),(n=s.querySelector("[data-action='grass']"))==null||n.addEventListener("click",()=>{c("skyrim"),this.startTouchGrass(this.settings.touchGrass.defaultMinutes)}),(r=s.querySelector("[data-action='pack']"))==null||r.addEventListener("click",()=>{c("skyrim"),this.startPack("items",10)}),(d=s.querySelector("[data-action='dismiss']"))==null||d.addEventListener("click",()=>c("skyrim"))}showTouchGrassOverlay(){var d,h;const t=this.session.touchGrass.endsAt,o=S.sort(()=>Math.random()-.5).slice(0,3),s=chrome.runtime.getURL("assets/skyrim-skeleton.mp4"),a=v("touchgrass",`<div class="brd-fullscreen"><div class="brd-video-wrap"><video autoplay loop muted playsinline><source src="${s}" type="video/mp4"></video></div><div class="brd-card"><h2>🌿 Touch Grass Mode</h2><p>Feed locked. Time to go outside.</p><div class="brd-timer" id="brd-tg-timer">00:00</div><div class="brd-tips">${o.map(x=>`<div class="brd-tip">${x}</div>`).join("")}</div><div class="brd-btn-row" style="justify-content:center;"><button class="brd-btn brd-btn-danger" data-action="bypass">Emergency Bypass 😏</button></div></div></div>`),n=a.querySelector("#brd-tg-timer"),r=setInterval(()=>{const x=Math.max(0,t-Date.now()),q=Math.floor(x/6e4),B=Math.floor(x%6e4/1e3);n&&(n.textContent=`${String(q).padStart(2,"0")}:${String(B).padStart(2,"0")}`),x<=0&&(clearInterval(r),this.endTouchGrass(),c("touchgrass"))},1e3);(d=a.querySelector("[data-action='bypass']"))==null||d.addEventListener("click",()=>{clearInterval(r),this.bypassTouchGrass(),c("touchgrass")}),(h=a.querySelector("video"))==null||h.play().catch(()=>{})}showVibeCheckOverlay(){var s;const t=C.map(a=>`<div class="brd-vibe-card" data-vibe="${a.id}"><span class="brd-vibe-emoji">${a.emoji}</span><span class="brd-vibe-label">${a.label}</span></div>`).join(""),o=v("vibecheck",`<div class="brd-fullscreen"><div class="brd-card"><h2>✨ Vibe Check</h2><p>What are you here for?</p><div class="brd-vibe-grid">${t}</div><div class="brd-btn-row" style="justify-content:center;"><button class="brd-btn brd-btn-ghost" data-action="skip">Skip</button></div></div></div>`);o.querySelectorAll("[data-vibe]").forEach(a=>a.addEventListener("click",()=>{this.setVibeIntent(a.dataset.vibe),c("vibecheck")})),(s=o.querySelector("[data-action='skip']"))==null||s.addEventListener("click",()=>c("vibecheck"))}showBuiltDifferentDeniedOverlay(){var o,s,a;const t=v("denied",'<div class="brd-fullscreen"><div class="brd-card"><h2 style="font-size:28px;text-align:center;color:#f87171;">No you are not.</h2><p style="text-align:center;">You thought you could just scroll away? Pick one.</p><div class="brd-btn-row" style="justify-content:center;"><button class="brd-btn brd-btn-success" data-action="grass">🌿 Touch Grass (5 min)</button><button class="brd-btn brd-btn-primary" data-action="pack">🍱 Start Pack</button><button class="brd-btn brd-btn-ghost" data-action="vibe">✨ Vibe Check</button></div></div></div>');(o=t.querySelector("[data-action='grass']"))==null||o.addEventListener("click",()=>{c("denied"),this.startTouchGrass(this.settings.touchGrass.defaultMinutes)}),(s=t.querySelector("[data-action='pack']"))==null||s.addEventListener("click",()=>{c("denied"),this.startPack("items",10)}),(a=t.querySelector("[data-action='vibe']"))==null||a.addEventListener("click",()=>{c("denied"),this.showVibeCheckOverlay()})}removeAllOverlays(){R()}}console.log("[brainrot detox] YouTube content script loaded"),window.location.pathname.startsWith("/shorts")||new H().init()})();
