var Le=Object.defineProperty;var Ae=(y,g,C)=>g in y?Le(y,g,{enumerable:!0,configurable:!0,writable:!0,value:C}):y[g]=C;var l=(y,g,C)=>Ae(y,typeof g!="symbol"?g+"":g,C);(function(){"use strict";const y={basedMax:35,mediumMax:65,intervention:80,cooldownMs:6e4},g={active:!1,mode:"items",limit:10,consumed:0,startedAt:0},C={active:!1,endsAt:0,bypassCount:0},ee=["[>] Step outside for 2 minutes","[~] Drink a glass of water","[o] Do 5 deep breaths","[!] Do 10 jumping jacks","[*] Look at something 20 feet away for 20 seconds","[♪] Put on your favorite song","[>] Text a friend something nice","[=] Open a window and feel the air"],_={based:{emoji:"( ._.)",label:"Based",hint:"Keep it chill, you're doing great."},medium:{emoji:"(-_-;)",label:"Medium Cooked",hint:"Maybe take a breather soon?"},cooked:{emoji:"(x_x) ",label:"Absolutely Cooked",hint:"Bro. Step away from the screen."}},te=[{id:"Chill",emoji:"~_~",label:"Just Vibing"},{id:"Learn",emoji:"o_O",label:"Learn Something"},{id:"Laugh",emoji:"xD",label:"Get Entertained"},{id:"Music",emoji:"♪♫",label:"Music / Audio"},{id:"JustHere",emoji:"...",label:"I'm Just Here"}],z=.3,se=15e3,ie=500,oe=3e3,re=2e3,j=4e3,ne=.35,ae=3,H={edge:"right",verticalOffset:20};function k(t){return Math.max(0,Math.min(100,t))}function N(t){return t==="Chill"||t==="Laugh"?15e3:t==="Learn"||t==="JustHere"?25e3:2e4}function de(t,s,e,i){const o=Math.min(1,t/s),r=Math.min(1,e/150),n=Math.min(1,i/60),a=o*35+r*35+n*30;return Math.round(Math.min(100,a))}function ce(t,s,e,i,o){const r=o==="Learn"?1.3:o==="JustHere"?1.1:o==="Laugh"?.8:o==="Chill"?.7:1;if(e){const a=s*r,d=t*(1-z)+a*z;return k(d)}if(i<se)return t;const n=i<45e3?1:i<9e4?2:4;return k(t-n)}function le(t,s,e,i){if(s>0)return k(t+s);const o=N(e);return i<o?t:i<6e4?k(t-1):k(t-3)}function B(t,s=y){return t<=s.basedMax?"Based":t<=s.mediumMax?"Medium Cooked":"Absolutely Cooked"}function q(t){return t==="Based"?_.based:t==="Medium Cooked"?_.medium:_.cooked}function F(t,s,e=y,i=Date.now()){return!(t<e.intervention||i-s<e.cooldownMs)}function V(t){return t>=100}function he(t,s,e,i){if(s>0)return k(t+s);const o=N(e);return i<o?t:i<6e4?k(t-1):k(t-3)}function u(t){return new Promise(s=>{chrome.runtime.sendMessage(t,e=>{chrome.runtime.lastError?s({success:!1,error:chrome.runtime.lastError.message}):s(e??{success:!1,error:"No response"})})})}function W(t,s=1){return t.active?{...t,consumed:t.consumed+s}:t}function U(t,s=Date.now()){return t.active?t.mode==="items"?t.consumed>=t.limit:t.mode==="time"?(s-t.startedAt)/6e4>=t.limit:!1:!1}function ue(t,s=Date.now()){if(!t.active)return{current:0,total:0,percent:0};if(t.mode==="items")return{current:t.consumed,total:t.limit,percent:Math.min(100,Math.round(t.consumed/t.limit*100))};const e=(s-t.startedAt)/6e4,i=Math.max(0,t.limit-e),o=Math.floor(i),r=Math.floor((i-o)*60);return{current:Math.round(e),total:t.limit,percent:Math.min(100,Math.round(e/t.limit*100)),timeRemaining:`${String(o).padStart(2,"0")}:${String(r).padStart(2,"0")}`}}const $="brd_widget_positions";async function be(t,s){return(await chrome.storage.local.get(t))[t]??s}async function pe(t,s){await chrome.storage.local.set({[t]:s})}async function Y(){return be($,{})}async function fe(t){return(await Y())[t]??H}async function me(t,s){const e=await Y();e[t]=s,await pe($,e)}const O="brd-overlay-host",ge=8;let p=null,x={...H},f=null,I=null;function K(){if(p)return p;let t=document.getElementById(O);if(t||(t=document.createElement("div"),t.id=O,t.style.cssText="position:fixed;top:0;left:0;width:0;height:0;z-index:2147483647;pointer-events:none;",document.documentElement.appendChild(t)),t.shadowRoot)return p=t.shadowRoot,X(),p;p=t.attachShadow({mode:"open"});const s=document.createElement("style");s.textContent=Se,p.appendChild(s);const e=document.createElement("link");return e.rel="stylesheet",e.href="https://fonts.googleapis.com/css2?family=Caveat:wght@400;600;700&family=Patrick+Hand&display=swap",p.appendChild(e),X(),p}function M(t,s){const e=K(),i=e.querySelector(`[data-overlay="${t}"]`);i&&i.remove();const o=document.createElement("div");return o.setAttribute("data-overlay",t),o.innerHTML=s,e.appendChild(o),o}function ve(t){const s=K();I=t.onActivate??null;let e=s.querySelector('[data-overlay="widget"]');if(!e){e=document.createElement("div"),e.setAttribute("data-overlay","widget"),e.innerHTML=`
    ...
    `,s.appendChild(e);const i=e.querySelector(".brd-widget");i&&(f==null||f(),f=we(i,t.siteKey))}return xe(e,t),L(),e}function b(t){const s=p;if(!s)return;const e=s.querySelector(`[data-overlay="${t}"]`);e&&(t==="widget"&&(f==null||f(),f=null,I=null),e.remove())}function ye(){const t=p;t&&(f==null||f(),f=null,I=null,t.querySelectorAll("[data-overlay]").forEach(s=>s.remove()))}async function ke(t){x=await fe(t),L()}async function X(){var i;const t=await chrome.runtime.sendMessage({type:"GET_SETTINGS"}),s=t!=null&&t.success&&((i=t.data)!=null&&i.theme)?t.data.theme:"light",e=document.getElementById(O);e&&(s==="dark"?e.classList.add("brd-dark"):e.classList.remove("brd-dark"))}function xe(t,s){const e=t.querySelector(".brd-widget");if(!e)return;e.dataset.score=s.score.toFixed(3),e.dataset.status=s.status;const i=q(s.status),o=s.status==="Based"?"brd-score-based":s.status==="Medium Cooked"?"brd-score-medium":"brd-score-cooked",r=e.querySelector(".brd-widget-emoji"),n=e.querySelector(".brd-widget-label"),a=e.querySelector(".brd-widget-score"),d=e.querySelector(".brd-widget-pack"),m=e.querySelector(".brd-widget-pack-label"),h=e.querySelector(".brd-pack-fill");r&&(r.textContent=i.emoji),n&&(n.textContent=i.label),a&&(a.textContent=String(Math.round(s.score)),a.className=`brd-widget-score ${o}`),d&&m&&h&&(s.pack?(d.hidden=!1,m.textContent=s.pack.label,h.style.width=`${Math.max(0,Math.min(100,s.pack.percent))}%`):(d.hidden=!0,m.textContent="",h.style.width="0%"))}function L(){const t=p==null?void 0:p.querySelector(".brd-widget");t&&(t.style.left=x.edge==="left"?"0px":"auto",t.style.right=x.edge==="right"?"0px":"auto",t.style.bottom=`${P(x.verticalOffset,t)}px`)}function we(t,s){let e=null,i=!1,o=0,r=0,n=0;const a=()=>{e=null,i=!1,t.style.cursor="grab",t.style.transition="all 0.2s ease"},d=c=>{c.pointerType==="mouse"&&c.button!==0||c.target.closest("button, input, a")||(e=c.pointerId,i=!1,o=c.clientX,r=c.clientY,n=window.innerHeight-t.getBoundingClientRect().bottom,t.style.cursor="grabbing",t.style.transition="none",t.setPointerCapture(c.pointerId),c.preventDefault())},m=c=>{if(e!==c.pointerId)return;const E=c.clientX-o,S=r-c.clientY;if(!i&&Math.hypot(E,S)>=ge&&(i=!0),!i)return;const A=P(n+S,t);t.style.left=x.edge==="left"?"0px":"auto",t.style.right=x.edge==="right"?"0px":"auto",t.style.bottom=`${A}px`},h=async c=>{if(e!==c.pointerId)return;const E=i;if(t.hasPointerCapture(c.pointerId)&&t.releasePointerCapture(c.pointerId),E){const S=t.getBoundingClientRect();x={edge:c.clientX<window.innerWidth/2?"left":"right",verticalOffset:P(window.innerHeight-S.bottom,t)},L(),await me(s,x)}else I==null||I();a()},w=c=>{e===c.pointerId&&(t.hasPointerCapture(c.pointerId)&&t.releasePointerCapture(c.pointerId),L(),a())};return t.addEventListener("pointerdown",d),t.addEventListener("pointermove",m),t.addEventListener("pointerup",h),t.addEventListener("pointercancel",w),t.style.cursor="grab",()=>{t.removeEventListener("pointerdown",d),t.removeEventListener("pointermove",m),t.removeEventListener("pointerup",h),t.removeEventListener("pointercancel",w)}}function P(t,s){const e=Math.max(0,window.innerHeight-s.getBoundingClientRect().height-8);return Math.max(0,Math.min(t,e))}const Se=`
...
`,G="brd:locationchange";class Ce{constructor(){l(this,"settings");l(this,"session");l(this,"enabled",!1);l(this,"lastSignalAt",0);l(this,"lastActivityAt",0);l(this,"scrollCount",0);l(this,"swipeCount",0);l(this,"maxCookedShown",!1);l(this,"builtDifferentDismissed",!1);l(this,"tickTimer",null);l(this,"cleanupFns",[]);l(this,"velocitySamples",[])}async init(){var s;this.enabled&&this.destroy();try{const e=await u({type:"GET_SETTINGS"});if(!e.success)return;if(this.settings=e.data,!this.settings.masterEnabled||!((s=this.settings.sites[this.site])!=null&&s.enabled)){console.log(`[brainrot detox] Disabled for ${this.site}`);return}const i=await this.getCurrentTabId(),o=await u({type:"GET_SESSION",payload:{tabId:i}});o.data?this.session=o.data:(this.session={site:this.site,tabId:i,startedAt:Date.now(),cookedScore:0,cookedStatus:"Based",lastInterventionAt:0,packState:{...g},touchGrass:{...C},vibeIntent:this.settings.vibeCheck.activeIntent,itemsConsumed:0,scrollEvents:0},await u({type:"UPDATE_SESSION",payload:{tabId:i,patch:this.session}})),this.enabled=!0,this.lastSignalAt=0,this.lastActivityAt=Date.now(),this.velocitySamples=[],await ke(this.site),this.mountCookedWidget(),this.setupObservers(),this.scheduleNextTick(),this.session.touchGrass.active&&this.session.touchGrass.endsAt>Date.now()&&this.showTouchGrassOverlay(),console.log(`[brainrot detox] ${this.site} adapter initialized`)}catch(e){console.error(`[brainrot detox] Init error for ${this.site}:`,e)}}destroy(){for(this.enabled=!1,this.tickTimer!==null&&(clearTimeout(this.tickTimer),this.tickTimer=null);this.cleanupFns.length>0;){const s=this.cleanupFns.pop();try{s==null||s()}catch(e){console.warn(`[brainrot detox] Cleanup error for ${this.site}:`,e)}}this.velocitySamples=[],this.removeAllOverlays()}scheduleNextTick(){if(!this.enabled)return;this.tickTimer!==null&&clearTimeout(this.tickTimer);const s=Date.now()-this.lastActivityAt<re?ie:oe;this.tickTimer=window.setTimeout(async()=>{await this.tick(),this.scheduleNextTick()},s)}recordActivity(s=Date.now()){this.lastActivityAt=s}recordSignalUnits(s,e=Date.now()){s<=0||(this.velocitySamples.push({at:e,units:s}),this.lastSignalAt=e,this.recordActivity(e),this.pruneVelocitySamples(e))}recordSuccessfulNavigation(s=1,e=Date.now()){s<=0||(this.swipeCount+=s,this.recordSignalUnits(s,e))}getVelocityMultiplier(s=Date.now()){this.pruneVelocitySamples(s);const i=this.velocitySamples.reduce((o,r)=>o+r.units,0)/(j/1e3);return Math.min(ae,1+ne*Math.pow(i,1.5))}addCleanup(s){this.cleanupFns.push(s)}registerEventListener(s,e,i,o){s.addEventListener(e,i,o),this.addCleanup(()=>s.removeEventListener(e,i,o))}registerMutationObserver(s,e,i){const o=new MutationObserver(i);return o.observe(s,e),this.addCleanup(()=>o.disconnect()),o}registerInterval(s,e){const i=window.setInterval(s,e);return this.addCleanup(()=>clearInterval(i)),i}registerRuntimeMessageListener(s){chrome.runtime.onMessage.addListener(s),this.addCleanup(()=>chrome.runtime.onMessage.removeListener(s))}registerLocationChangeListener(s){const e=window;let i=e.__brdLocationChangePatch;if(!i){const o=()=>window.dispatchEvent(new Event(G)),r=history.pushState,n=history.replaceState;history.pushState=function(...a){const d=r.apply(history,a);return o(),d},history.replaceState=function(...a){const d=n.apply(history,a);return o(),d},window.addEventListener("popstate",o),i={refCount:0,popstateListener:o,originalPushState:r,originalReplaceState:n},e.__brdLocationChangePatch=i}i.refCount++,window.addEventListener(G,s),this.addCleanup(()=>{window.removeEventListener(G,s);const o=e.__brdLocationChangePatch;o&&(o.refCount--,!(o.refCount>0)&&(history.pushState=o.originalPushState,history.replaceState=o.originalReplaceState,window.removeEventListener("popstate",o.popstateListener),delete e.__brdLocationChangePatch))})}buildPackDisplay(){if(!this.session.packState.active)return null;const s=ue(this.session.packState);return{label:this.session.packState.mode==="time"&&s.timeRemaining?`[#] Pack: ${s.timeRemaining}`:`[#] Pack: ${s.current}/${s.total}`,percent:s.percent}}renderCookedWidget(s,e){ve({siteKey:this.site,score:s,status:e,pack:this.buildPackDisplay(),onActivate:()=>this.showVibeCheckOverlay()})}getGeneralVelocityUnits(s){return s+this.scrollCount*.25}computeGeneralBurstBonus(s,e){return s<=0?0:Math.max(0,e-1)*Math.min(12,s)*.6}resetMomentum(){this.velocitySamples=[],this.lastSignalAt=0}async tick(){if(!this.enabled)return;const s=Date.now(),e=this.session.cookedScore,i=this.getNewItemsSinceLastTick();this.session.itemsConsumed+=i,this.session.scrollEvents+=this.scrollCount;const o=this.scrollCount>0||i>0||this.swipeCount>0,r=this.lastSignalAt===0?0:s-this.lastSignalAt;if(this.builtDifferentDismissed&&o){this.builtDifferentDismissed=!1,this.scrollCount=0,this.swipeCount=0,this.onBuiltDifferentDenied();return}let n=e;if(this.session.packState.active)n=e;else if(this.site==="shorts"){const a=i*this.getVelocityMultiplier(s);n=le(e,a,this.session.vibeIntent,r)}else{const a=this.getGeneralVelocityUnits(i);a>0&&this.recordSignalUnits(a,s);const d=(s-this.session.startedAt)/6e4,m=de(d,this.settings.cooked.sessionCapMinutes,this.session.scrollEvents,this.session.itemsConsumed),h=this.getVelocityMultiplier(s),w=ce(e,m,o,r,this.session.vibeIntent);n=Math.min(100,w+this.computeGeneralBurstBonus(a,h))}this.scrollCount=0,this.swipeCount=0,this.session.cookedScore=n,this.session.cookedStatus=B(n,this.settings.cooked.thresholds),this.session.packState.active&&(this.session.packState=W(this.session.packState,i),U(this.session.packState,s)&&this.onPackComplete()),this.session.packState.active||(V(n)?this.maxCookedShown||(this.maxCookedShown=!0,this.onMaxCooked()):(n<95&&(this.maxCookedShown=!1),n>=e&&F(n,this.session.lastInterventionAt,this.settings.cooked.thresholds,s)&&(this.session.lastInterventionAt=s,this.onIntervention()))),this.updateCookedWidget(this.session.cookedScore,this.session.cookedStatus),await u({type:"UPDATE_SESSION",payload:{tabId:this.session.tabId,patch:this.session}})}onIntervention(){u({type:"LOG_EVENT",payload:{eventType:"intervention"}}),this.showInterventionOverlay()}onMaxCooked(){this.session.lastInterventionAt=Date.now(),u({type:"LOG_EVENT",payload:{eventType:"intervention"}}),this.showSkyrimOverlay("Your brain is absolutely cooked (x_x)")}onPackComplete(){this.session.packState={...g},this.maxCookedShown=!1,u({type:"END_PACK",payload:{tabId:this.session.tabId}}),this.showSkyrimOverlay("[#] Pack Complete! Time to touch grass."),this.updateCookedWidget(this.session.cookedScore,this.session.cookedStatus)}onBuiltDifferentDenied(){this.showBuiltDifferentDeniedOverlay()}async startPack(s,e){await u({type:"START_PACK",payload:{tabId:this.session.tabId,mode:s,limit:e}}),this.session.packState={active:!0,mode:s,limit:e,consumed:0,startedAt:Date.now()},this.session.cookedScore=0,this.session.cookedStatus="Based",this.maxCookedShown=!1,this.builtDifferentDismissed=!1,this.resetMomentum(),this.updateCookedWidget(this.session.cookedScore,this.session.cookedStatus)}async startTouchGrass(s){await u({type:"START_TOUCH_GRASS",payload:{tabId:this.session.tabId,minutes:s}}),this.session.touchGrass={active:!0,endsAt:Date.now()+s*6e4,bypassCount:0},this.showTouchGrassOverlay()}async endTouchGrass(){await u({type:"END_TOUCH_GRASS",payload:{tabId:this.session.tabId}}),this.session.touchGrass={...C},this.session.cookedScore=0,this.session.cookedStatus="Based",this.maxCookedShown=!1,this.resetMomentum(),this.removeAllOverlays(),this.mountCookedWidget()}async bypassTouchGrass(){this.session.touchGrass.bypassCount++,u({type:"LOG_EVENT",payload:{eventType:"bypass"}}),await this.endTouchGrass()}setVibeIntent(s){this.session.vibeIntent=s,u({type:"UPDATE_SESSION",payload:{tabId:this.session.tabId,patch:{vibeIntent:s}}}),u({type:"LOG_EVENT",payload:{eventType:"vibe_check"}})}pruneVelocitySamples(s=Date.now()){this.velocitySamples=this.velocitySamples.filter(e=>s-e.at<=j)}async getCurrentTabId(){return new Promise(s=>{const e=Math.floor(Math.random()*1e6);u({type:"GET_CURRENT_TAB"}).then(i=>{var o;s(((o=i.data)==null?void 0:o.id)??e)})})}}class Ee extends Ce{constructor(){super(...arguments);l(this,"site","instagram-reels");l(this,"itemsSinceLastTick",0);l(this,"lastReelId","");l(this,"lastWheelTime",0);l(this,"wheelDebounceMs",500);l(this,"handleRuntimeMessage",(e,i,o)=>{var r,n,a;return e.type==="END_TOUCH_GRASS"?(this.session.touchGrass={active:!1,endsAt:0,bypassCount:0},b("skyrim"),b("touchgrass"),this.thawFeed(),o({success:!0}),!1):e.type==="TRIGGER_TOUCH_GRASS"?(this.startTouchGrass(((r=e.payload)==null?void 0:r.minutes)??5),o({success:!0}),!1):e.type==="TRIGGER_PACK"?(this.startPack(((n=e.payload)==null?void 0:n.mode)??"items",((a=e.payload)==null?void 0:a.limit)??10),o({success:!0}),!1):(e.type==="TRIGGER_VIBE_CHECK"&&(this.showVibeCheckOverlay(),o({success:!0})),!1)})}getReelsVideo(){return document.querySelector("div[role='presentation'] video")??document.querySelector("._ac8m video")??document.querySelector("video")}freezeFeed(){const e=this.getReelsVideo();e&&!e.paused&&e.pause()}thawFeed(){const e=this.getReelsVideo();e&&e.paused&&e.play().catch(()=>{})}setupObservers(){this.registerEventListener(window,"wheel",r=>{const n=r,a=Date.now();Math.abs(n.deltaY)>20&&a-this.lastWheelTime>=this.wheelDebounceMs&&(this.lastWheelTime=a,this.scrollCount++,this.recordActivity(a))},{passive:!0}),this.registerEventListener(window,"keydown",r=>{const n=r;(n.key==="ArrowDown"||n.key==="j")&&(this.scrollCount++,this.recordActivity())},{passive:!0});let e=0;this.registerEventListener(window,"touchstart",r=>{var n;e=((n=r.touches[0])==null?void 0:n.clientY)??0},{passive:!0}),this.registerEventListener(window,"touchend",r=>{var a;const n=e-(((a=r.changedTouches[0])==null?void 0:a.clientY)??0);Math.abs(n)>50&&(this.scrollCount++,this.recordActivity())},{passive:!0});const i=()=>{const r=window.location.pathname.match(/\/reel\/([^/?]+)/),n=(r==null?void 0:r[1])??"";if(n){if(!this.lastReelId){this.lastReelId=n;return}n!==this.lastReelId&&(this.lastReelId=n,this.itemsSinceLastTick++,this.recordSuccessfulNavigation())}};this.registerLocationChangeListener(i),this.registerInterval(i,250),i();const o=()=>{const r=document.body??document.documentElement;this.registerMutationObserver(r,{childList:!0,subtree:!0},()=>i())};document.readyState==="complete"?o():this.registerEventListener(window,"load",o,{once:!0}),this.registerRuntimeMessageListener(this.handleRuntimeMessage)}getNewItemsSinceLastTick(){const e=this.itemsSinceLastTick;return this.itemsSinceLastTick=0,e}async tick(){if(!this.enabled)return;const e=Date.now(),i=this.session.cookedScore,o=this.getNewItemsSinceLastTick();this.session.itemsConsumed+=o,this.session.scrollEvents+=this.scrollCount;const r=this.scrollCount>0||o>0||this.swipeCount>0,n=this.lastSignalAt===0?0:e-this.lastSignalAt;if(this.builtDifferentDismissed&&r){this.builtDifferentDismissed=!1,this.scrollCount=0,this.swipeCount=0,this.onBuiltDifferentDenied();return}let a=i;if(!this.session.packState.active){const d=o*this.getVelocityMultiplier(e);a=he(i,d,this.session.vibeIntent,n)}this.scrollCount=0,this.swipeCount=0,this.session.cookedScore=a,this.session.cookedStatus=B(a,this.settings.cooked.thresholds),this.session.packState.active&&(this.session.packState=W(this.session.packState,o),U(this.session.packState,e)&&this.onPackComplete()),this.session.packState.active||(V(a)?this.maxCookedShown||(this.maxCookedShown=!0,this.onMaxCooked()):(a<95&&(this.maxCookedShown=!1),a>=i&&F(a,this.session.lastInterventionAt,this.settings.cooked.thresholds,e)&&(this.session.lastInterventionAt=e,this.onIntervention()))),this.updateCookedWidget(this.session.cookedScore,this.session.cookedStatus),await u({type:"UPDATE_SESSION",payload:{tabId:this.session.tabId,patch:this.session}})}mountCookedWidget(){this.renderCookedWidget(this.session.cookedScore,this.session.cookedStatus)}updateCookedWidget(e,i){this.renderCookedWidget(e,i)}showInterventionOverlay(){var o,r,n;const e=q(this.session.cookedStatus),i=M("intervention",`
        ...
        `);(o=i.querySelector("[data-action='dismiss']"))==null||o.addEventListener("click",()=>b("intervention")),(r=i.querySelector("[data-action='pack']"))==null||r.addEventListener("click",()=>{b("intervention"),this.startPack("items",10)}),(n=i.querySelector("[data-action='grass']"))==null||n.addEventListener("click",()=>{b("intervention"),this.startTouchGrass(this.settings.touchGrass.defaultMinutes)})}showBuiltDifferentDeniedOverlay(){var i,o,r;this.freezeFeed();const e=M("denied",`
            <div class="brd-fullscreen">
                <div class="brd-card">
        ...
        `);(i=e.querySelector("[data-action='grass']"))==null||i.addEventListener("click",()=>{b("denied"),this.thawFeed(),this.startTouchGrass(this.settings.touchGrass.defaultMinutes)}),(o=e.querySelector("[data-action='pack']"))==null||o.addEventListener("click",()=>{b("denied"),this.thawFeed(),this.startPack("items",10)}),(r=e.querySelector("[data-action='vibe']"))==null||r.addEventListener("click",()=>{b("denied"),this.thawFeed(),this.showVibeCheckOverlay()})}showSkyrimOverlay(e){var n,a,d;const i=chrome.runtime.getURL("assets/skyrim-skeleton.mp4");this.freezeFeed();const o=M("skyrim",`
            <div class="brd-fullscreen">
        ...
        `),a=n.querySelector(".brd-zen-img"),d=n.querySelector(".brd-zen-webcam"),m=n.querySelector(".brd-zen-caption");let h=null,w=0;const c=["breathe.","you are here.","it's okay.","look at this.","touch grass.","be present.","slow down.","this is real life."],E=async v=>{const D=r[v%r.length];if(D==="WEBCAM"){if(a.style.display="none",d.style.display="block",m.textContent="hi. this is you.",!h)try{h=await navigator.mediaDevices.getUserMedia({video:!0,audio:!1}),d.srcObject=h}catch{await E(v+1)}return}d.style.display="none",a.style.display="block",a.src=D,m.textContent=c[Math.floor(Math.random()*c.length)]};E(w);const S=window.setInterval(()=>{w++,E(w)},4e3),A=n.querySelector("#brd-tg-timer"),R=window.setInterval(()=>{const v=Math.max(0,e-Date.now()),D=Math.floor(v/6e4),Te=Math.floor(v%6e4/1e3);A&&(A.textContent=`${String(D).padStart(2,"0")}:${String(Te).padStart(2,"0")}`),v<=0&&(clearInterval(R),clearInterval(S),h&&h.getTracks().forEach(Me=>Me.stop()),this.endTouchGrass(),this.thawFeed(),b("touchgrass"))},1e3);this.addCleanup(()=>clearInterval(S)),this.addCleanup(()=>clearInterval(R)),(Z=n.querySelector("[data-action='bypass']"))==null||Z.addEventListener("click",()=>{clearInterval(R),clearInterval(S),h&&h.getTracks().forEach(v=>v.stop()),this.bypassTouchGrass(),this.thawFeed(),b("touchgrass")})}showVibeCheckOverlay(){var o;const e=te.map(r=>`
        ...
        `);i.querySelectorAll("[data-vibe]").forEach(r=>{r.addEventListener("click",()=>{this.setVibeIntent(r.dataset.vibe),b("vibecheck")})}),(o=i.querySelector("[data-action='skip']"))==null||o.addEventListener("click",()=>b("vibecheck"))}removeAllOverlays(){ye(),this.thawFeed()}}console.log("[brainrot detox] Instagram Reels content script loaded");let T=null,J=location.href;function Ie(){return/^\/(reel|reels)\//.test(location.pathname)||location.pathname.startsWith("/explore/reels")}function Q(){if(Ie()){T||(T=new Ee,T.init());return}T&&(T.destroy(),T=null)}Q(),new MutationObserver(()=>{location.href!==J&&(J=location.href,Q())}).observe(document.body,{subtree:!0,childList:!0})})();
